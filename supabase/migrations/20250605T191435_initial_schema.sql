...
--
-- Name: processing_status_enum; Type: TYPE; Schema: public; Owner: postgres
--
...
--
-- Name: enqueue_binder_upload(uuid, text, character); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.enqueue_binder_upload(p_user_id uuid, p_storage_path text, p_content_hash character) RETURNS json
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_id uuid;
...
--
-- Name: record_pipeline_results(uuid, jsonb, public.processing_status_enum, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.record_pipeline_results(_page_id uuid, _items jsonb, _status public.processing_status_enum DEFAULT 'review_pending'::public.processing_status_enum, _error text DEFAULT NULL::text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    RETURN;
...
--
-- Name: binder_page_uploads; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: pipeline_review_items; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: binder_page_uploads binder_page_uploads_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pipeline_review_items pipeline_review_items_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pipeline_review_items unique_binder_tile; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_binder_page_uploads_user_hash_unique; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_binder_page_uploads_user_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_job_queue_binder_page_upload_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_job_queue_status_run_at; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_pipeline_review_items_binder_id; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_pipeline_review_items_status; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: job_queue on_job_queue_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER on_job_queue_updated BEFORE UPDATE ON public.job_queue FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();


--
-- Name: pipeline_review_items on_pipeline_review_items_updated; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER on_pipeline_review_items_updated BEFORE UPDATE ON public.pipeline_review_items FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
...
--
-- Name: binder_page_uploads binder_page_uploads_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: job_queue job_queue_binder_page_upload_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pipeline_review_items pipeline_review_items_binder_page_upload_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pipeline_review_items pipeline_review_items_confirmed_card_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: pipeline_review_items pipeline_review_items_pipeline_suggested_card_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: binder_page_uploads Users can insert their own binder page uploads; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: binder_page_uploads Users can update their own binder page uploads; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: pipeline_review_items Users can update their own pipeline review items; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: binder_page_uploads Users can view their own binder page uploads; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: pipeline_review_items Users can view their own pipeline review items; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: binder_page_uploads; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.binder_page_uploads ENABLE ROW LEVEL SECURITY;

--
-- Name: pipeline_review_items; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: TYPE job_status_enum; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TYPE processing_status_enum; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION enqueue_binder_upload(p_user_id uuid, p_storage_path text, p_content_hash character); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION record_pipeline_results(_page_id uuid, _items jsonb, _status public.processing_status_enum, _error text); Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE binder_page_uploads; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE pipeline_review_items; Type: ACL; Schema: public; Owner: postgres
--
