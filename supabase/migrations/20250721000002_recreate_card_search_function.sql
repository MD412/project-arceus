-- Drop and recreate the card search RPC function with correct column name
-- The actual column is 'image_url', not 'image_urls'

-- Drop the existing function
DROP FUNCTION IF EXISTS search_cards(TEXT);

-- Create the function with correct column name
