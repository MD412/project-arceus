-- Quick Fix: Populate set_name from set_code
-- This updates all cards with NULL set_name based on their set_code
-- Run this in Supabase Studio SQL Editor

-- Create a temporary function to map set codes to set names
...
BEGIN
  RETURN CASE code
    ...
    -- Add more as needed...
    ELSE code -- Fallback: use code itself if not found
  END;
END;
$$ LANGUAGE plpgsql;

-- Update all cards with NULL set_name
UPDATE cards 
...
DROP FUNCTION get_set_name_from_code;
...
-- Show any remaining NULL set_names
