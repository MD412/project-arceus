...
def create_summary_grid(all_tiles_info):
    ...
    # Save summary
    grid.save(OUTPUT_DIR / "summary_3x3_grid.jpg")
    print(f"🎨 3x3 summary grid saved: summary_3x3_grid.jpg")

def test_with_visuals():
    """Test the enhanced pipeline and create visual outputs."""
    print("🎨 Testing Enhanced Pipeline with Visual Outputs!")
    ...
    original_image.save(OUTPUT_DIR / "original_full_image.jpg")
    print(f"📐 Original image saved: original_full_image.jpg ({original_image.size})")
    ...
    print(f"\n🎉 CHECK YOUR OUTPUT FOLDER FOR VISUAL RESULTS!")
    print(f"🔥 Key files to check:")
    print(f"   📷 original_full_image.jpg - Your original binder photo")
    print(f"   🎨 summary_3x3_grid.jpg - 3x3 grid with all detections!")
